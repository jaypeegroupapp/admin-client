  ...
  if (orders.length === 0) {
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
        <h3 className="text-sm font-medium text-gray-700 mb-4">Pending Orders</h3>
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link href="/orders" className="text-xs text-blue-600 hover:text-blue-700">
          View all →
        </Link>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-xs text-gray-500">
                {order.productId?.name} • R{order.totalAmount?.toFixed(2)}
              </p>
            </div>
