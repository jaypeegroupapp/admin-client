...
import { completeMineOrderAction } from "@/actions/order";
...
export function CompleteMineOrderModal({ orderId, open, onClose }: Props) {
  ...
  const handleSubmit = () => {
    ...
    startTransition(async () => {
      const result = await completeMineOrderAction(orderId);
